...
*Ошибки, выявленные в ходе проверки задания:*

- PATCH /users/<user_id> редактирование полей продавца возвращает 500, ошибку (403 для простого пользователя). Данные запроса:
```
{
	"first_name": "User",
	"last_name": "Two",
...
```
- PATCH /ads/<ad_id> не возвращает тело запроса
- GET users/<user_id>/ads возвращает 500 ошибку
- GET /ads?tags=семейный - фильтрация с одним параметром возвращает 500 ошибку